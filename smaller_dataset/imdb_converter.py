...
def make_Aliases(title_akas):
    ...
    # Output to file
    Aliases.to_csv('normalized/Aliases.tsv',index=False,na_rep=r'\N',sep='\t')
...
def make_Alias_types(title_akas):
    ...
    # Output to file
    Alias_types.to_csv('normalized/Alias_types.tsv',index=False,na_rep=r'\N',sep='\t')
...
def make_Alias_attributes(title_akas):
    ...
    # Output to file
    Alias_attributes.to_csv('normalized/Alias_attributes.tsv',index=False,na_rep=r'\N',sep='\t')
...
def make_Directors_and_Writers(title_crew):
    ...
    # Output to file
    Directors.to_csv('normalized/Directors.tsv',index=False,na_rep=r'\N',sep='\t')
    Writers.to_csv('normalized/Writers.tsv',index=False,na_rep=r'\N',sep='\t')
...
def make_Episode_belongs_to(title_episode):
    ...
    # Output to file
    Episode_belongs_to.to_csv('normalized/Episode_belongs_to.tsv',index=False,na_rep=r'\N',sep='\t')
...
def make_Names_(name_basics):
    ...
    # Output to file
    Names_.to_csv('normalized/Names_.tsv',index=False,na_rep=r'\N',sep='\t')
...
def make_Name_worked_as(name_basics):
    ...
    # Output to file
    Name_worked_as.to_csv('normalized/Name_worked_as.tsv',index=False,na_rep=r'\N',sep='\t')
...
def make_Known_for(name_basics):
    ...
    # Output to file
    Known_for.to_csv('normalized/Known_for.tsv',index=False,na_rep=r'\N',sep='\t')
...
def make_Principals(title_principals):
    ...
    # Output to file
    Principals.to_csv('normalized/Principals.tsv',index=False,na_rep=r'\N',sep='\t')
...
def make_Had_role(title_principals):
    ...
    # Output to file
    Had_role.to_csv('normalized/Had_role.tsv',index=False,na_rep=r'\N',sep='\t')
...
def make_Titles(title_basics):
    ...
    # Output to file
    Titles.to_csv('normalized/Titles.tsv',index=False,na_rep=r'\N',sep='\t')
...
def make_Title_genres(title_basics):
    ...
    # Output to file
    Title_genres.to_csv('normalized/Title_genres.tsv',index=False,na_rep=r'\N',sep='\t')
...
def make_Title_ratings(title_ratings):
    ...
    # Output to file
    Title_ratings.to_csv('normalized/Title_ratings.tsv',index=False,na_rep=r'\N',sep='\t')
